const WhatsAppMessages = {
     ...
     * @constructor
     */
    Message: function(messageType, groupId, messageId, sender, date, content) {
    ...
    getMessage(messageRow) {
        ...
        if(messageText !== 'reset') {
            const messageTextMatcher = /[-|+]\d+/.exec(messageText)
    ...
    fetchMessages() {
        ...
        if(messagesContainer == null) {
            ...
            const messagesRows = messagesContainer.querySelectorAll("div[role='row']")
        ...
        setTimeout(WhatsAppMessages.fetchMessages, 5000)
    },
